  ...
  const steps = [
    {
      ...
      label: "Interpret",
      subs: [
        "GitHub API · repo meta + 5K README + listening commits",
        "Extract product model · audiences · search keywords",
      ],
    ...
    },
    {
      ...
      subs: [
        ...
        "Per-channel tone · source-attributed guardrails",
      ],
    ...
    },
    {
      ...
      badge: "Minds AI",
      subs: [
        "3 Minds sparks · parallel /completion",
        "Extract sentiment · upvote · key concern",
      ],
